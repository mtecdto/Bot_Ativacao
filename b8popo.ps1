...
$cred=New-Object System.Management.Automation.PSCredential("dtouserb8",$password)
...
##*===============================================
	...
	[string]$appScriptAuthor = '<Gustavo da Silva Alves> <Matheus Fillipe> <Alef Gomes>'
    [string]$appContactAuthor = 'https://www.linkedin.com/in/gustavo-silva-97b6b0201/
    https://www.linkedin.com/in/matheus-fillipe/
    https://www.linkedin.com/in/alef-de-souza-gomes/'
	##*===============================================
...
function setStateUsing {
    ...
    Invoke-SqlUpdate "UPDATE general_keys SET keystate=1,bancada='b8' WHERE idkey=$idkey;"
